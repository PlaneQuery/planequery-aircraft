...
def get_latest_aircraft_csv_df():
    ...
    csv_path = Path("/Users/jonahgoode/Documents/PlaneQuery/Code/planequery-aircraft/data/faa_releasable_historical/planequery_aircraft_2024-06-05_2024-06-08.csv")
    import pandas as pd
